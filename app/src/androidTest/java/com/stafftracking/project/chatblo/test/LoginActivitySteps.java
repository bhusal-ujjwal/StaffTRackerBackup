...
////
////        import com.stafftracking.project.chatblo.LoginActivity;
...
////        onView(ViewMatchers.withId(com.stafftracking.project.chatblo.R.id.login_email)).perform(typeText(email));
////    }
////
////    @When("^I input password \"(.*?)\"$")
////    public void I_input_password(final String password) {
////        onView(ViewMatchers.withId(com.stafftracking.project.chatblo.R.id.login_password)).perform(typeText(password), closeSoftKeyboard());
////    }
////
////    @When("^I press submit button$")
////    public void I_press_submit_button() {
////        onView(ViewMatchers.withId(com.stafftracking.project.chatblo.R.id.login_btn)).perform(click());
////    }
////
//////    @Then("^ I should see suceessful login message")
//////    public void I_should_see_successful_login_message_(){onView(withId(R.id.messa))}
////
////    @When("^I tap sign up button$")
////    public void I_tap_sign_up_button() {
////        onView(ViewMatchers.withId(com.stafftracking.project.chatblo.R.id.reg_create_btn)).perform(click());
////    }
////
////    @Then("^I should see error on the (\\S+)$")
////    public void I_should_see_error_on_the_editTextView(final String viewName) {
////        int viewId = (viewName.equals("email")) ? com.stafftracking.project.chatblo.R.id.login_email : com.stafftracking.project.chatblo.R.id.login_email;
////        int messageId = (viewName.equals("email")) ? com.stafftracking.project.chatblo.R.string.msg : R.string.msg_password_error;
////
